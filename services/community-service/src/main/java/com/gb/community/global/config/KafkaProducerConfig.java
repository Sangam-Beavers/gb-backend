...
import com.gb.community.global.event.MilestoneAchievedEvent;
...
/**
 * Kafka Producer 설정 (Phase 3 — 마일스톤 이벤트 발행, BE-8. wallet KafkaProducerConfig 패턴 복제).
 *
...
public class KafkaProducerConfig {
     ...
     * Kafka 장애가 글/댓글 작성 응답 지연으로 번진다 — 짧게 캡해 빠르게 실패시키고 ERROR 로그로 넘긴다
