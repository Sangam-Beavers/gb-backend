...
/**
 * 도메인 서비스 → {@link MilestoneEventPublisher} 사이의 <b>내부</b> Spring ApplicationEvent (Phase 3 — BE-8).
 *
 * <p>도메인 서비스(게시글 작성/댓글 작성)는 비즈니스 트랜잭션 안에서 이 가벼운 이벤트만
 ...
 *
 * @param userPublicId  마일스톤을 달성한 회원(=작성자)의 public_id(UUID — MSA 경계 참조, CLAUDE §7)
