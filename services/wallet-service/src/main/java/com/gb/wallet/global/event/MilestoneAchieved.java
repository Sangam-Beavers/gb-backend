...
/**
 * 도메인 서비스 → {@link MilestoneEventPublisher} 사이의 <b>내부</b> Spring ApplicationEvent (Phase 2).
 *
 * <p>도메인 서비스(계좌 등록/충전/송금)는 비즈니스 트랜잭션 안에서 이 가벼운 이벤트만
 ...
 *
 * @param userPublicId  마일스톤을 달성한 회원의 public_id(UUID — MSA 경계 참조, CLAUDE §7)
