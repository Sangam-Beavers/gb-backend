 ...
 *
 * <p><b>시각 소스 = UTC 고정(10D member-core-4·community-3):</b> 기본 Auditing은 JVM 기본존의
 ...
 * 시점부터 UTC를 명시해 'LocalDateTime = UTC' 가정을 코드로 보장한다(4서비스 공통 패턴). 비감사 시각
 * 캡처({@code LocalDateTime.now()} 직접 호출부)도 전부 {@code now(ZoneOffset.UTC)}로 통일돼 있다.
 */
@Configuration
